package io.dataease.plugins.datasource.intersystems.query;
...
import io.dataease.plugins.datasource.intersystems.provider.IntersystemsConfig;
 ...
 */
@Component()
public class IntersystemsQueryProvider extends QueryProvider {
    ...
    public String createRawQuerySQL(String table, List<DatasetTableField> fields, Datasource ds) {
        ...
        IntersystemsConfig intersystemsConfig = new Gson().fromJson(ds.getConfiguration(), IntersystemsConfig.class);
        return MessageFormat.format("SELECT {0} FROM {1}", StringUtils.join(array, ","),
                intersystemsConfig.getSchema() + ".\"" + table + "\"");
    }
